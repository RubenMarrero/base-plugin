...
class CustomTaxonomyController extends BaseController
{
	...
	public function setSubpages()
	{
		$this->subpages = array(
			array(
				'parent_slug' => 'base_plugin', 
				'page_title' => 'Custom Taxonomies', 
				'menu_title' => 'Taxonomy Manager', 
				'capability' => 'manage_options', 
				'menu_slug' => 'base_taxonomy', 
	...
	public function setSettings()
	{
		$args = array(
			array(
				'option_group' => 'base_plugin_tax_settings',
				'option_name' => 'base_plugin_tax',
	...
	{
		$options = get_option( 'base_plugin_tax' ) ?: array();
